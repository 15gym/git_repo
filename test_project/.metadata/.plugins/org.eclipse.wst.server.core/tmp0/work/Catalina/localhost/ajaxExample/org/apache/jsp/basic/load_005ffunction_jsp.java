 ...
 * Generated at: 2018-09-04 06:01:57 UTC
...
public final class load_005ffunction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\tform > span { display: none; }\r\n");
      out.write("\t\r\n");
      out.write("</style>\r\n");
      out.write("<script type=\"text/javascript\" src=\"js/jquery-3.3.1.min.js\"></script>\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("$(function() {\r\n");
      out.write("\t// 기본적으로 1depth의 드롭다운을 로드함\r\n");
      out.write("\t$(\"#category1\").load(\"ajax/text/category-data.html #category1-1\",\r\n");
      out.write("\t\t\tfunction() {\r\n");
      out.write("\t\t\t\t// 로딩이 완료되면 드롭다운을 감싸는 태그 요소를 화면에 표시함\r\n");
      out.write("\t\t\t\t$(this).show();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t);\r\n");
      out.write("\r\n");
      out.write("    // 드롭다운은 body상에 없으므로 이벤트를 \"미리\"정의해 놓아야 한다.\r\n");
      out.write("    // 1depth에 대한 change 이벤트 정의\r\n");
      out.write("    $(document).on(\"change\", \"#category1 > select\", function() {\r\n");
      out.write("    \t// 1dpeth가 변경되므로 2,3depth는 초기화.\r\n");
      out.write("    \t$(\"#category2\").empty().hide();\r\n");
      out.write("    \t$(\"#category3\").empty().hide();\r\n");
      out.write("    \t// 선택된 항목이 지시하는 하위 카테고리 페이지의 URL얻기\r\n");
      ...
      out.write("    });\r\n");
      out.write("    \r\n");
      out.write(" \t// 2depth에 대한 change 이벤트 정의\r\n");
      out.write("    $(document).on(\"change\", \"#category2 > select\", function() {\r\n");
      out.write("    \t// 2dpeth가 변경되므로 3depth는 초기화.\r\n");
      out.write("    \t$(\"#category3\").empty().hide();\r\n");
      out.write("    \t// 선택된 항목이 지시하는 하위 카테고리 페이지의 URL얻기\r\n");
      out.write("    \tvar target = $(this).find(\"option:selected\").attr(\"data-target\");\r\n");
      out.write("    \tvar selector = \"ajax/text/category-data.html \" + target;\r\n");
